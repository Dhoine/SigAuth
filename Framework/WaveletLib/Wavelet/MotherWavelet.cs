...
namespace WaveletStudio.Wavelet
{
    ...
    public class MotherWavelet
    {
        ...
        public FiltersStruct Filters
        {
            get
            {
                if (_filters.DecompositionHighPassFilter == null) CalculateFilters();
                return _filters;
            }
        }
        ...
        public void CalculateFilters()
        {
            ...
            for (var i = 0; i < filterLength; i++) _filters.ReconstructionLowPassFilter[i] = ScalingFilter[i] * sqrt2;
            ...
            for (var i = filterLength - 1; i >= 0; i--)
            {
                ...
                if (k % 2 != 0) _filters.ReconstructionHighPassFilter[k] *= -1;
                k++;
            }
